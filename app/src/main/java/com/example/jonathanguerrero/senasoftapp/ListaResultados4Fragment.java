 ...
 */
public class ListaResultados4Fragment extends Fragment {

    private RecyclerView recyclerView;
    private AdaptadorResultados adaptadorResultados;
    //private ImageView imgBack;

    public ListaResultados4Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_lista_resultados4, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.recyclerListadoResultados4);
